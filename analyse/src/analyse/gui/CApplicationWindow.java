 ...
 * </p>
 */
public class CApplicationWindow extends Window implements IRunnableContext {

	private static final int CHGAP = (CPlatform.isLinux() || CPlatform.isWindows())?5:20;
            ...
            for (int i = 0; i < ws.length; i++) {
                ...
                if (w == seperator1) { // Separator
                    ...
                    w.setBounds(clientArea.x, clientArea.y + clientArea.height
                            - e.y, clientArea.width - CHGAP, e.y);
                    clientArea.height -= e.y + VGAP;
                } else {
     ...
     */
    public CApplicationWindow(Shell parentShell) {
        super(parentShell);
    }
