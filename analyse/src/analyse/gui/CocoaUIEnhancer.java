...
public class CocoaUIEnhancer {
    ...
    private void initialize( Object callbackObject )
        ...
        if ( appName != null ) {
        	String about = "About ";
        	if(AnalysePreferences.getPreferenceStore().getString(AnalysePreferences.LANGUAGE).equals(AnalysePreferences.FRENCH_LANGUAGE)) about = "\u00c0 propos de ";
        ...
        if ( appName != null ) {
        	String quit = "Quit ";
        	if(AnalysePreferences.getPreferenceStore().getString(AnalysePreferences.LANGUAGE).equals(AnalysePreferences.FRENCH_LANGUAGE)) quit = "Quitter ";
        ...
        if(AnalysePreferences.getPreferenceStore().getString(AnalysePreferences.LANGUAGE).equals(AnalysePreferences.FRENCH_LANGUAGE)) pref = "Préférences ";
        ...
        Object nsStr = invoke( nsstringCls, "stringWith", new Object[] { pref + appName } );
