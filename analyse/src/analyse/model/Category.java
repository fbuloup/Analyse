...
public class Category implements IResource {
	...
	public boolean delete() {
		...
		if(!succeed) Log.logErrorMessage(Messages.getString("Category.ImpossibleDelete") + getLocalPath());
	...
	public void rename(String newName) {
		IMathEngine mathEngine = MathEngineFactory.getInstance().getMathEngine();
		if(!mathEngine.renameChannel(getParent().getLocalPath(), oldName, name)) Log.logErrorMessage(Messages.getString("Channel.ImpossibleRename") + getLocalPath() + Messages.getString("Channel.OldName") + oldName + Messages.getString("Channel.NewName") + name +") !");
		else {
