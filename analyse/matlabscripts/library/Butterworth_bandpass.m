...
function Butterworth_bandpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order)
%beginAnalyseHeader
%GUIFunctionName = Butterworth_bandpass
%MatlabFunctionName = Butterworth_bandpass
%ShortDescritpion = <p>Butterworth bandpass filter</p>
%LongDescription = <p>Butterworth bandpass filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
