%This function modify end cut value of selected
%signals. End cut is a duration at the end of signal that have not to be displayed in charts.function EndCut (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, EndCut)
%beginAnalyseHeader
%GUIFunctionName = End Cut
%MatlabFunctionName = EndCut
%ShortDescritpion = <p>This function modify end cut value of selected signals</p>
%LongDescription = <p>This function modify end cut value of selected signals. End cut is a duration at the end of signal that have not to be displayed in charts.</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
%param1Component = 1
%param1Label = EndCut
%param1ToolTip = End cut value (in sec.)
...
%for TrialNumber = TrialsList
	value =floor(EndCut*InputSignal1.SampleFrequency);
	InputSignal1.EndCut(TrialsList) = InputSignal1.NbSamples(TrialsList) - value;
%end
