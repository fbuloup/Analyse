...
function Integration (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Integration
%MatlabFunctionName = Integration
%ShortDescritpion = <p>Integration</p>
%LongDescription = <p>Integration</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	for i=1:L
		OutputSignal1.Values(TrialNumber,i)=trapz(InputSignal1.Values(TrialNumber,1:i))/(InputSignal1.SampleFrequency);
	end
