...
function Chebyshev1_bandpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order, Pass_ripple)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev_bandpass
%MatlabFunctionName = Chebyshev1_bandpass
%ShortDescritpion = <p>Chebyshev bandpass filter (type 1)</p>
%LongDescription = <p>Chebyshev bandpass filter (type 1)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
