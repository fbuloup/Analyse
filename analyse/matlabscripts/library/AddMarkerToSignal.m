%This function simply adds a marker to a signalfunction AddMarkerToSignal (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = AddMarkerToSignal
%MatlabFunctionName = AddMarkerToSignal
%ShortDescritpion = <p>This function simply adds a marker to a signal</p>
%LongDescription = <p>This function simply adds a marker to a signal</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 1
%FieldsUsedNumber = 0
