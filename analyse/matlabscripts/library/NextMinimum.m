%This function finds next minimum after a specified marker and before second one
function NextMinimum (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = NextMinimum
%MatlabFunctionName = NextMinimum
%ShortDescritpion = <p>Next Minimum between two markers</p>
%LongDescription = <p>This function finds next minimum after a specified marker and before a second one</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 2
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	if(~isempty(fromTrialIndices) && ~isempty(toTrialIndices))
		...
		%Compute derivative between  first time index and trial length
