...
function AbsoluteValue (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = AbsoluteValue
%MatlabFunctionName = AbsoluteValue
%ShortDescritpion = <p>Absolute value</p>
%LongDescription = <p>Absolute value of a signal</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	OutputSignal1.Values(TrialNumber , : ) = abs(InputSignal1.Values(TrialNumber, : ));
