...
function Multiplication (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Multiplication
%MatlabFunctionName = Multiplication
%ShortDescritpion = <p>Multiplication</p>
%LongDescription = <p>Multiplication</p>
%SignalsUsedNumber = 2
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	for i=1:L
		OutputSignal1.Values(TrialNumber,i)=InputSignal1.Values(TrialNumber,i)*InputSignal2.Values(TrialNumber,i);
	end
