%This function modify front cut value of selected
%signals. Front cut is a duration at the beginning of signal that have not to be displayed in charts.
%It has to be given in seconds.
function FrontCut (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, FrontCut)
%beginAnalyseHeader
%GUIFunctionName = Front cut
%MatlabFunctionName = FrontCut
%ShortDescritpion = <p>This function modify front cut value of selected signals</p>
%LongDescription = <p>This function modify front cut value of selected signals. Front cut is a duration at the beginning of signal that have not to be displayed in charts and must be given in seconds</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
%signalsModifiedNumber = 1
%param1MatlabType = float
%param1Component = 1
%param1Label = FrontCut
%param1ToolTip = Front cut value (in sec.)
%param1RegExp = (^[+]?\d*\.?\d*[1-9]+\d*([eE][-+]?[0-9]+)?$)|(^[+]?[1-9]+\d*\.\d*([eE][-+]?[0-9]+)?$)
%param1AvailableListValue = 
%param1DefaultValue = 1
...
%for TrialNumber = TrialsList
	value =floor(FrontCut*InputSignal1.SampleFrequency);
	InputSignal1.FrontCut(TrialsList) = value;
%end
%endFunction
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
