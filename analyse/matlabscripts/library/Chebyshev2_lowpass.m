...
function Chebyshev2_lowpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev2_lowpass
%MatlabFunctionName = Chebyshev2_lowpass
%ShortDescritpion = <p>Chebyshev lowpass filter (type 2)</p>
%LongDescription = <p>Chebyshev lowpass filter (type 2)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby2(Order,Stop_attenuation,Wc);
