...
function Division (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Division
%MatlabFunctionName = Division
%ShortDescritpion = <p>Division</p>
%LongDescription = <p>Division</p>
%SignalsUsedNumber = 2
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
