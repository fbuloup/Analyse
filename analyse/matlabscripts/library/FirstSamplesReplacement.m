%This functions replaces the N first samples by the N+1 one.
function FirstSamplesReplacement (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, FirstSamplesNumber)
%beginAnalyseHeader
%GUIFunctionName = First Samples Replacement
%MatlabFunctionName = FirstSamplesReplacement
%ShortDescritpion = <p>This functions replaces the N first samples by the N+1 one.</p>
%LongDescription = <p>This functions replaces the N first samples by the N+1 one.</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
%param1Component = 1
%param1Label = FirstSamplesNumber
%param1ToolTip = First Samples Number
%param1RegExp = ^[+]?0*[1-9]+[0-9]*$
...
%beginFunction
OutputSignal1.Values = InputSignal1.Values;
for TrialNumber = TrialsList
	value = InputSignal1.Values(TrialNumber , FirstSamplesNumber + 1);
	OutputSignal1.Values(TrialNumber, 1:FirstSamplesNumber) =value;
end
