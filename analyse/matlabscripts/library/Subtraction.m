...
function Subtraction (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Subtraction
%MatlabFunctionName = Subtraction
%ShortDescritpion = <p>Subtraction</p>
%LongDescription = <p>Subtraction of two signals</p>
%SignalsUsedNumber = 2
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	OutputSignal1.Values(TrialNumber,:)=InputSignal1.Values(TrialNumber,:)-InputSignal2.Values(TrialNumber,:);
