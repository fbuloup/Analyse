...
function Rise_start (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, DeltaT, DevPercent)
%beginAnalyseHeader
%GUIFunctionName = Rise_start
%MatlabFunctionName = Rise_start
%ShortDescritpion = <p>Rise start</p>
%LongDescription = <p>Creates a marker where the signal begins to rise</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
