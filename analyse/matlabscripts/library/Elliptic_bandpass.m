...
function Elliptic_bandpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order, Pass_ripple, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Elliptic_bandpass
%MatlabFunctionName = Elliptic_bandpass
%ShortDescritpion = <p>Elliptic bandpass filter</p>
%LongDescription = <p>Elliptic bandpass filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
