...
function Addition (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Addition
%MatlabFunctionName = Addition
%ShortDescritpion = <p>Addition</p>
%LongDescription = <p>Addition of two signals</p>
%SignalsUsedNumber = 2
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
