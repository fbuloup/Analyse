%Duplicates a group of markers.function DuplicateMarkers (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = Duplicate Markers
%MatlabFunctionName = DuplicateMarkers
%ShortDescritpion = <p>Duplicate markers</p>
%LongDescription = <p>Duplicates a group of markers. For a group of markers of a given signal, this function duplicates, ie it creates a new group of markers with same values ??in the same signal.</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 1
%FieldsUsedNumber = 0
...
%for TrialNumber = TrialsList
	...
	OutputMarker1.Values=InputMarker1.Values;
