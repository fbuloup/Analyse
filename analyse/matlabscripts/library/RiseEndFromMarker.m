...
function RiseEndFromMarker (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, DeltaT, DevPercent)
%beginAnalyseHeader
%GUIFunctionName = RiseEndFromMarker
%MatlabFunctionName = RiseEndFromMarker
...
for TrialNumber = TrialsList
	...
	if(~isempty(index))
		...
		while ((InputSignal1.Values(TrialNumber,i)>=moy+ecart*n)&(i<L))
			i=i+1;
		end
