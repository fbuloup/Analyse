...
function Chebyshev2_bandstop (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev2_bandstop
%MatlabFunctionName = Chebyshev2_bandstop
%ShortDescritpion = <p>Chebyshev bandstop filter (type 2)</p>
%LongDescription = <p>Chebyshev bandstop filter (type 2)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby2(Order,Stop_attenuation,Wc,'stop');
