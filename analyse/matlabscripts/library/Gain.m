...
function Gain (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Gain)
%beginAnalyseHeader
%GUIFunctionName = Gain
%MatlabFunctionName = Gain
%ShortDescritpion = <p>Gain multiplication</p>
%LongDescription = <p>Gain multiplication</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	OutputSignal1.Values(TrialNumber,:)=InputSignal1.Values(TrialNumber,:)*Gain;
