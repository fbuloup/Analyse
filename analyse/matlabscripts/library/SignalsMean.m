...
function SignalsMean (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = SignalsMean
%MatlabFunctionName = SignalsMean
%ShortDescritpion = <p>Average of two signals</p>
%LongDescription = <p>Makes the average of two signals</p>
%SignalsUsedNumber = 2
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
    ...
    OutputSignal1.Values( TrialNumber , : ) =  ( InputSignal1.Values( TrialNumber , : ) + InputSignal2.Values( TrialNumber , : ) )/2;
