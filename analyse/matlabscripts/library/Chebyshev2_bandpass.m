...
function Chebyshev2_bandpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev2_bandpass
%MatlabFunctionName = Chebyshev2_bandpass
%ShortDescritpion = <p>Chebyshev bandpass filter (type 2)</p>
%LongDescription = <p>Chebyshev bandpass filter (type 2)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby2(Order,Pass_ripple,Wc);
