...
function Butterworth_highpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order)
%beginAnalyseHeader
%GUIFunctionName = Butterworth_highpass
%MatlabFunctionName = Butterworth_highpass
%ShortDescritpion = <p>Butterworth highpass filter</p>
%LongDescription = <p>Butterworth highpass filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
