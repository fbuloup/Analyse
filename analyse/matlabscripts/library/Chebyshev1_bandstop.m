...
function Chebyshev1_bandstop (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order, Pass_ripple)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev1_bandstop
%MatlabFunctionName = Chebyshev1_bandstop
%ShortDescritpion = <p>Chebyshev bandstop filter (type 1)</p>
%LongDescription = <p>Chebyshev bandstop filter (type 1)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby1(Order,Pass_ripple,Wc,'stop');
