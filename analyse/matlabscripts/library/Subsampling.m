...
function Subsampling (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Step)
%beginAnalyseHeader
%GUIFunctionName = Subsampling
%MatlabFunctionName = Subsampling
%ShortDescritpion = <p>Subsampling</p>
%LongDescription = <p>Reduces the sampling frequency and creates a re-sampled signal</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
%param1Component = 1
%param1Label = Step
%param1ToolTip = Frequency ratio
%param1RegExp = ^[+]?0*[1-9]+[0-9]*$
%param1AvailableListValue = 
%param1DefaultValue = 2
...
for TrialNumber = TrialsList
	...
	for i=1:(L/Step)
			OutputSignal1.Values(TrialNumber,i)=InputSignal1.Values(TrialNumber,index);
			index=index+Step;
	end	
	OutputSignal1.SampleFrequency=(InputSignal1.SampleFrequency)/Step;
