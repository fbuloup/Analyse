...
function Chebyshev1_lowpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order, Pass_ripple)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev1_lowpass
%MatlabFunctionName = Chebyshev1_lowpass
%ShortDescritpion = <p>Chebyshev lowpass filter (type 1)</p>
%LongDescription = <p>Chebyshev lowpass filter (type 1)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby1(Order,Pass_ripple,Wc);
