...
function Rise_end (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, DeltaT, DevPercent)
%beginAnalyseHeader
%GUIFunctionName = Rise_end
%MatlabFunctionName = Rise_end
%ShortDescritpion = <p>Rise end</p>
%LongDescription = <p>Creates a marker where the signal stops rising</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
