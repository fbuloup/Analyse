%This function simply substracts a marker to a signalfunction SubstractMarkerToSignal (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = SubstractMarkerToSignal
%MatlabFunctionName = SubstractMarkerToSignal
%ShortDescritpion = <p>This function simply substracts a marker to a signal</p>
%LongDescription = <p>This function simply substracts a marker to a signal</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 1
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	OutputSignal1.Values(TrialNumber, :) = InputSignal1.Values(TrialNumber, :) - InputMarker1.Values(TrialNumber, 3);
