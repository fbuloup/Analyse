...
function FFT (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = FFT
%MatlabFunctionName = FFT
%ShortDescritpion = <p>FFT</p>
%LongDescription = <p>Fast Fourier transform</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	%f=(0:L-1)/L*InputSignal1.SampleFrequency;
	
	y = fftshift( fft(InputSignal1.Values(TrialNumber,:),L) );
	OutputSignal1.Values(TrialNumber,:) =abs(y)/L;
	OutputSignal1.SampleFrequency = L/InputSignal1.SampleFrequency;
