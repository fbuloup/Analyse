...
function Chebyshev1_highpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order, Pass_ripple)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev1_passband
%MatlabFunctionName = Chebyshev1_highpass
%ShortDescritpion = <p>Chebyshev passband filter (type 1)</p>
%LongDescription = <p>Chebyshev passband filter (type 1)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby1(Order,Pass_ripple,Wc,'high');
