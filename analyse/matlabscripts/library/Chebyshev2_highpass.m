...
function Chebyshev2_highpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Chebyshev2_highpass
%MatlabFunctionName = Chebyshev2_highpass
%ShortDescritpion = <p>Chebyshev highpass filter (type 2)</p>
%LongDescription = <p>Chebyshev highpass filter (type 2)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=cheby2(Order,Stop_attenuation,Wc,'high');
