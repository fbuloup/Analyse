%This function simply substracts a signal to a markerfunction SubstractSignalToMarker (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = SubstractSignalToMarker
%MatlabFunctionName = SubstractSignalToMarker
%ShortDescritpion = <p>This function simply substracts a signal to a maker</p>
%LongDescription = <p>This function simply substracts a signal to a marker</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 1
%FieldsUsedNumber = 0
