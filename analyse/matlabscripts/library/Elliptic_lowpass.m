...
function Elliptic_lowpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Pass_ripple, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Elliptic_lowpass
%MatlabFunctionName = Elliptic_lowpass
%ShortDescritpion = <p>Elliptic lowpass filter</p>
%LongDescription = <p>Elliptic lowpass filter (Cauer filter)</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=ellip(Order,Pass_ripple,Stop_attenuation,Wc);
