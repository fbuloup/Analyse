...
%beginAnalyseHeader
%GUIFunctionName = Butterworth_lowpass
%MatlabFunctionName = Butterworth_lowpass
%ShortDescritpion = <p>Butterworth lowpass filter</p>
%LongDescription = <p>Butterworth lowpass filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
