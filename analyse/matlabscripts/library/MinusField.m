%Subtsract field values from an input signal for each trial
function MinusField (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)
%beginAnalyseHeader
%GUIFunctionName = MinusField
%MatlabFunctionName = MinusField
%ShortDescritpion = <p>Subtsract field values from an input signal for each trial</p>
%LongDescription = <p>Subtsract field values from an input signal for each trial</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 1
...
for TrialNumber = TrialsList
	...
	OutputSignal1.Values(TrialNumber,:)=InputSignal1.Values(TrialNumber,:) - InputField1.Values(TrialNumber);
