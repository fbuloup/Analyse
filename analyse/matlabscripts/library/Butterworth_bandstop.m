...
function Butterworth_bandstop (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff1, Cutoff2, Order)
%beginAnalyseHeader
%GUIFunctionName = Butterworth_bandstop
%MatlabFunctionName = Butterworth_bandstop
%ShortDescritpion = <p>Butterworth bandstop filter</p>
%LongDescription = <p>Butterworth bandstop filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
for TrialNumber = TrialsList
	...
	[num,den]=butter(Order,Wc,'stop');
	OutputSignal1.Values(TrialNumber,:)=filtfilt(num,den,InputSignal1.Values(TrialNumber,:));nyquist=0.5*InputSignal1.SampleFrequency;
