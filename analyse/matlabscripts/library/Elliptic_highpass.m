...
function Elliptic_highpass (TrialsList , signalsNamesList, markersNamesList, fieldsNamesList, signalsNamesSuffix, newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber, Cutoff, Order, Pass_ripple, Stop_attenuation)
%beginAnalyseHeader
%GUIFunctionName = Elliptic_highpass
%MatlabFunctionName = Elliptic_highpass
%ShortDescritpion = <p>Elliptic highpass filter</p>
%LongDescription = <p>Elliptic highpass filter</p>
%SignalsUsedNumber = 1
%MarkersUsedNumber = 0
%FieldsUsedNumber = 0
...
%param3MatlabType = float
%param3Component = 1
%param3Label = Pass_ripple
%param3ToolTip = Passband ripple
%param3RegExp = (^[+]?\d*\.?\d*[1-9]+\d*([eE][-+]?[0-9]+)?$)|(^[+]?[1-9]+\d*\.\d*([eE][-+]?[0-9]+)?$)
%param3AvailableListValue = 
%param3DefaultValue = 3
%param3SignalsAvailable = false
%param3MarkersAvailable = false
%param3FieldsAvailable = false
%param4MatlabType = float
%param4Component = 1
%param4Label = Stop_attenuation
%param4ToolTip = Stopband attenuation
%param4RegExp = (^[+]?\d*\.?\d*[1-9]+\d*([eE][-+]?[0-9]+)?$)|(^[+]?[1-9]+\d*\.\d*([eE][-+]?[0-9]+)?$)
%param4AvailableListValue = 
%param4DefaultValue = 40
...
for TrialNumber = TrialsList
	...
	[num,den]=ellip(Order,Pass_ripple,Stop_attenuation,Wc,'high');
