...
function functionTemplate(TrialsList, signalsNamesList, markersNamesList,...
				   fieldsNamesList, signalsNamesSuffix,...
				   newMarkersNamesList, newFieldsNamesList, signalsModifiedNumber)

%beginAnalyseHeader
% guiFunctionName =  GUI function name
% matlabFunctionName = functionTemplate//Of course, the same name as the file in which the function is stored
% shortDescription = <p>short Description</p>
% longDescription = <p>Long Description</p>
% signalsUsedNumber = 0 // The n-uplet input signal. If this value is zero, no signals are used 
% markersUsedNumber = 0 // The n-uplet input marker. If this value is zero, no markers are used 
% fieldsUsedNumber = 0 // The n-uplet input field. If this value is zero, no fields are used 
% signalsCreatedNumber = 0 // The n-uplet output signal. If this value is zero, no signals are created 
% markersCreatedNumber = 0 // The n-uplet output marker. If this value is zero, no markers are created
% fieldsCreatedNumber = 0 // The n-uplet output field. If this value is zero, no fields are created
% signalsModifiedNumber = 0 // Number of input signals that will be modified in an n-uplet inputs
%endAnalyseHeader
%
...
for TrialNumber = TrialsList
	...
	%Obviously, you can supress the "for" loop over trials
	%if you find a way to vectorize your algorithm
end
%endFunction
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
