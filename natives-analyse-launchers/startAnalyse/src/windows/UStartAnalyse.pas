...
var
  StartAnalyseForm: TStartAnalyseForm;
  errorNum : Cardinal;
...
procedure TStartAnalyseForm.Label3Click(Sender: TObject);
var URL : String;
begin
...
procedure TStartAnalyseForm.Label3MouseEnter(Sender: TObject);
begin
  (Sender as TLabel).Font.Style := [fsUnderline];
end;

procedure TStartAnalyseForm.Label3MouseLeave(Sender: TObject);
begin
  (Sender as TLabel).Font.Style := [];
end;

procedure TStartAnalyseForm.Button1Click(Sender: TObject);
begin
  Application.Terminate;
end;

procedure TStartAnalyseForm.FormShow(Sender: TObject);
begin
  if(errorNum <> 0) then
  begin
