...
int main(int argc, char *argv[])
{
	...
	NSLog(@"Is path empty (Java not present) : %@", (javaIsPresent ? @"NOP" : @"YES"));
	...
	if(javaIsPresent) {
		...
		analyseInstallerLauncherPath = [analyseInstallerLauncherPath  stringByAppendingString:[[[[NSBundle mainBundle] bundlePath] stringByDeletingLastPathComponent] stringByAppendingPathComponent:@"OSXppc-analyse-installer.jar"]];		
